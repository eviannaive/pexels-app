			...
			<div className='text-center my-[50px]'>
				<label className='bg-white rounded-50px inline-flex items-center py-[6px] px-[8px] text-lg border-0 w-[80%] max-w-[400px]'>
					...
					<div className='w-[40px] h-[40px] flex justify-center items-center relative'>
						<div className={`w-full h-full bg-rose-100 rounded-full absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] scale-0 transition-transform duration-500 cursor-pointer ${searchBtnShow?'scale-100':''}`}></div>
